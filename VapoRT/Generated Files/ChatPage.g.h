...
namespace VapoRT
{
    partial ref class ChatPage : public ::VapoRT::Common::LayoutAwarePage, 
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::ItemsControl^ ConversationListView;
        private: ::Windows::UI::Xaml::Controls::TextBox^ MessageComposeBox;
